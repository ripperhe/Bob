!> 免责声明：以下信息仅供参考，请以服务商官网最新信息为准。更新时间：2020年8月30日。
...
谷歌翻译 API 秘钥申请成本较高，我自己申请的过程也不是特别顺畅，**不能保证按照我的操作方式一定能申请成功**。

在中国没办法直接访问谷歌服务，但是可以使用谷歌翻译 API。假设你是在国内，在申请谷歌翻译 API 之前，需要准备好以下道具：
...
在 Bob 的 偏好设置 > 服务 中，选中「文本翻译」，点击 `+` 号，选中「谷歌翻译」，然后将刚才获取到的秘钥填写到对应位置即可。
